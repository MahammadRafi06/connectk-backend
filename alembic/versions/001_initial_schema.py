...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("provider", sa.Enum("GKE", "AKS", "EKS", name="cloud_provider", create_type=False), nullable=False),
        ...
        sa.Column("status", sa.Enum("active", "unreachable", "pending", name="cluster_status", create_type=False), nullable=False, server_default="pending"),
        sa.Column("cache_ttl_seconds", sa.Integer, server_default="300"),
        sa.Column("gitops_tool", sa.Enum("argocd", "fluxcd", name="gitops_tool", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("source_type", sa.Enum("huggingface", "s3", "gcs", "azure_blob", "custom", name="model_source_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("backend", sa.Enum("sglang", "vllm", "trtllm", name="deployment_backend", create_type=False), nullable=False),
        sa.Column("deployment_type", sa.Enum("aggregated", "aggregated_route", "disaggregated_route", name="deployment_type_enum", create_type=False), nullable=False),
        ...
        sa.Column("status", sa.Enum("creating", "provisioning", "running", "updating", "degraded", "failed", "deleting", "deleted", "delete_failed", "rolling_back", name="deployment_status", create_type=False), nullable=False, server_default="creating"),
    ...
    op.create_table(
        ...
        sa.Column("action", sa.Enum("create", "read", "update", "delete", "login", "logout", "permission_change", "test_connection", name="audit_action", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("access_level", sa.Enum("list", "view", "deploy", "admin", name="access_level", create_type=False), nullable=False),
